...
3. `architecture.md`：Contracts / Framework / Revit2020 Adapter / SampleModule 分层与运行时组合规则。
...
- `PlugHub.Contracts`、`PlugHub.Framework`、`PlugHub.SampleModule` 不得引用 `Autodesk.Revit`。
