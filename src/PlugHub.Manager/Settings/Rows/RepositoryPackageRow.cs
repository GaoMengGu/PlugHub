...
namespace PlugHub.Manager.Settings.Rows
{
    internal sealed class RepositoryPackageRow
    {
        ...
        public static RepositoryPackageRow FromDescriptor(RepositoryPackageDescriptor descriptor, bool isRevitHostRunning, bool isLoadedInCurrentRuntime)
        {
            return new RepositoryPackageRow
            {
                ...
                TagBadges = (descriptor.Categories ?? new List<string>())
                    ...
                    .Take(3)
                    .ToList(),
                InstallState = InstallStateFor(descriptor.IsInstalled, descriptor.Version, descriptor.InstalledVersion, descriptor.PendingOperation, isRevitHostRunning, isLoadedInCurrentRuntime)
            };
        }
        ...
        public static string InstallStateFor(bool isInstalled, string version, string installedVersion, string pendingOperation, bool isRevitHostRunning, bool isLoadedInCurrentRuntime)
        {
