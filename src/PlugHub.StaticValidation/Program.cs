...
namespace PlugHub.StaticValidation
{
    internal static class Program
    {
        ...
        private static void ValidatePackageSourceAndReleaseBehavior()
        {
            ...
            Require(frameworkUpdateService.Contains("PLUGHUB_TEST_UPDATE_RELEASE_URI") && frameworkUpdateService.Contains("GitHub Test") && frameworkUpdateService.Contains("ContinueWhenNoUpdate") && frameworkUpdateService.Contains("GitHubTestPrereleaseList") && frameworkUpdateService.Contains("GetLatestTestPrerelease"), "framework update checks must support an opt-in latest-TV test update source without changing stable defaults.");
