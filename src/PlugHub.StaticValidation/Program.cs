...
namespace PlugHub.StaticValidation
{
    internal static class Program
    {
        ...
        private static void ValidateGiteeReleaseMirrorPackaging()
        {
            ...
            Require(releaseWorkflow.Contains("DeleteExistingGiteeRelease") && releaseWorkflow.Contains("Invoke-RestMethod -Method Delete") && releaseWorkflow.Contains("$deleteBody = New-FormBody") && releaseWorkflow.Contains("if ($statusCode -eq 404)"), "GitHub release workflow must delete and recreate existing Gitee releases before uploading replacement assets.");
