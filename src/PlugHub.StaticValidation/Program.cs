...
namespace PlugHub.StaticValidation
{
    internal static class Program
    {
        ...
        private static void ValidateUninstallerPackaging()
        {
            ...
            Require(managerUninstaller.Contains("Directory.Delete") && managerUninstaller.Contains("Refusing to delete a drive root") && managerUninstaller.Contains("RequiredInstallMarkers") && managerUninstaller.Contains("ContainsPlugHubInstallMarkers") && managerUninstaller.Contains("not a PlugHub install root") && !managerUninstaller.Contains("Path.GetFileName(fullPath), \"PlugHub\""), "Manager uninstaller must delete only a marker-validated PlugHub install directory.");
        ...
        private static void ValidateFrameworkAutoUpdateSpecification()
        {
            ...
            Require(managerUpdater.Contains("RequiredInstallMarkers") && managerUpdater.Contains("ContainsPlugHubInstallMarkers") && managerUpdater.Contains("not a PlugHub install root"), "Manager update maintenance must refuse non-PlugHub install directories.");
